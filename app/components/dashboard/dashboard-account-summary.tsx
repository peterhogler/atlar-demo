export default function DashboardAccountSummary({ accounts }: { accounts?: any }) {
    return (
        <div className="flex flex-col w-full border rounded-lg bg-gradient-to-t from-transparent to-gray-50 h-full">
            ...
            <div className="p-4 bg-white">
                ...
                <div>
                    ...
                    <select className="font-bold bg-transparent" name="currency" id="currency">
                        <option value="SEK">SEK</option>
                    </select>
                </div>
            </div>
            <hr />
            <div className="h-full p-4 grid grid-cols-3 align-center gap-3">
                {accounts &&
